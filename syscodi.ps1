...
$appList = @(
    ...
    @{cat="Microsoft Office"; name="Office 2016";     cmd="winget install -e --id Microsoft.Office"},
...
$lblActivarInfo.Location = New-Object Drawing.Point(10, 55)
$lblActivarInfo.Size = New-Object Drawing.Size(670, 16)
$lblActivarInfo.ForeColor = [Drawing.Color]::FromArgb(160, 200, 255)
...
$btnActivar.Add_Click({
    ...
    if ($confirm -eq [Windows.Forms.DialogResult]::Yes) {
        ...
        Write-Out " Activacion cancelada por el usuario." ([Drawing.Color]::Yellow)
    }
})
